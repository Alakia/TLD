...
bool LKTracker::trackf2f(const Mat& img1, const Mat& img2,vector<Point2f> &points1, vector<cv::Point2f> &points2)
{
	...
	/*
	ÏÈÀûÓÃœð×ÖËþLK¹âÁ÷·šžú×ÙÔ€²âÇ°Ïò¹ìŒ£
	*/
	calcOpticalFlowPyrLK( img1,img2, points1, points2, status,similarity, window_size, level, term_criteria, lambda, 0);

	/*
	ÔÙÍù»Øžú×Ù£¬²úÉúºóÏò¹ìŒ£
	*/
	calcOpticalFlowPyrLK( img2,img1, points2, pointsFB, FB_status,FB_error, window_size, level, term_criteria, lambda, 0);

	/*
	ŒÆËã FB-error£ºÇ°ÏòÓëºóÏò¹ìŒ£µÄÎó²î
	*/
	...
	/*
	ŽÓÇ°Ò»Ö¡ºÍµ±Ç°Ö¡ÍŒÏñÖÐ£šÒÔÃ¿žöÌØÕ÷µãÎªÖÐÐÄ£©Ê¹ÓÃÑÇÏóËØŸ«¶ÈÌáÈ¡10x10ÏóËØŸØÐÎ£šÊ¹ÓÃº¯ÊýgetRectSubPixµÃµœ£©£¬
	Æ¥ÅäÇ°Ò»Ö¡ºÍµ±Ç°Ö¡ÖÐÌáÈ¡µÄ10x10ÏóËØŸØÐÎ£¬µÃµœÆ¥ÅäºóµÄÓ³ÉäÍŒÏñ£šµ÷ÓÃmatchTemplate£©£¬µÃµœÃ¿Ò»žöµãµÄNCCÏà¹ØÏµÊý£šÒ²ŸÍÊÇÏàËÆ¶ÈŽóÐ¡£©
	*/
